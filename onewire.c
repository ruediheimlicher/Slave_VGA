...
/*******************************************/
// the bus is on PD5:
#define OW_GET_IN()    (PIND&(1<<PIND5))
// output and low:
#define OW_DIR_OUT_LOW()   PORTD&=~(1<<PORTD5);DDRD|=1<<DDD5
// output and high:
#define OW_DIR_OUT_HIGH()   PORTD|=(1<<PORTD5);DDRD|=1<<DDD5
// if input tie also pullup on:
//#define OW_DIR_IN()    DDRD&=~(1<<DDD5);PORTD|=1<<PORTD5
